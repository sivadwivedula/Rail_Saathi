...
public class getsdestode extends AsyncTask<String,Iterator,String>{
    @Override
            ...
            if (httpconn.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                for(int i=0;i<jsonArray.length();i++){
                   JSONObject jsonObject1=(JSONObject) jsonArray.get(i);
                    ...
                    MainActivity.dest_staion_names.add(temp1);
                    MainActivity.dest_staion_codes.add(temp2);
                    publishProgress();
                }
    ...
    protected void onProgressUpdate(Iterator... values) {
        ...
        MainActivity.ad1.notifyDataSetChanged();
